...
public class bookstore {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\online\\Downloads\\booik.jpg"));
		lblNewLabel.setBounds(10, 89, 94, 131);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\online\\Desktop\\book11.jpg"));
		lblNewLabel_1.setBounds(146, 89, 94, 136);
		frame.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\online\\Desktop\\book11.jpg"));
		lblNewLabel_2.setBounds(286, 103, 94, 122);
